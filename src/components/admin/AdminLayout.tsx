...
const AdminSidebar = component$<AdminSidebarProps>(({ isOpen, onToggle }) => {
        ...
        <div class="absolute bottom-0 left-0 right-0 p-4 border-t border-base-300">
          ...
          >
            ...
            <div class="flex-1">
              ...
              <p class="text-xs text-base-content/70">admin@example.com</p>
            </div>
          </Link>
        </div>
      </aside>
...
const AdminHeader = component$<{ onMenuToggle: QRL<() => void> }>(({ onMenuToggle }) => {
  const auth = useAuth();
      ...
      <div class="flex items-center justify-between h-full px-4">
        ...
        <div class="flex items-center space-x-4">
          ...
          <button class="btn btn-ghost btn-sm">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-5-5-5 5h5zM15 17H9a2 2 0 01-2-2V9a2 2 0 012-2h6a2 2 0 012 2v6a2 2 0 01-2 2z"/>
            </svg>
          </button>
...
export default component$(() => {
    ...
    return (
      <div class="min-h-screen flex items-center justify-center bg-base-200">
        <div class="text-center">
          <h1 class="text-2xl font-bold text-error mb-4">Access Denied</h1>
          <p class="text-base-content/70 mb-6">You need admin privileges to access this page.</p>
          <Link href="/auth/login" class="btn btn-primary">
            Login as Admin
          </Link>
        </div>
      </div>
  ...
  return (
    <div class="min-h-screen bg-base-100">
      <AdminSidebar isOpen={sidebarOpen.value} onToggle={toggleSidebar} />

...
export default component$(() => {
  ...
  return (
    <header
      class={`fixed top-4 left-1/2 z-10 -translate-x-1/2 items-center justify-center rounded-lg transition-shadow duration-100 ${isScrolled.value ? "bg-base-300 bg-opacity-75 shadow-lg backdrop-blur" : "bg-base-100 shadow-none"}`}
    >

 ...
 */
export const getAllBlogs = server$(async (
  token: string,
  ...
  try {
    ...
    console.log('🔍 Admin blog list result:', JSON.stringify(result, null, 2))
 ...
 */
export const getBlogById = server$(async (
  token: string,
  id: string
): Promise<Blog> => {
  const client = createAuthenticatedClient(token)
  ...
  try {
    ...
    console.log('🔍 Admin get blog by ID result:', JSON.stringify(result, null, 2))
 ...
 */
export const createBlog = server$(async (
  token: string,
  blogData: BlogCreateData
): Promise<Blog> => {
  const client = createAuthenticatedClient(token)
  ...
  try {
    ...
    console.log('🔍 Admin create blog result:', JSON.stringify(result, null, 2))
 ...
 * Update blog post
 */
export const updateBlog = server$(async (
  token: string,
  ...
  try {
    ...
    console.log('🔍 Admin update blog result:', JSON.stringify(result, null, 2))
 ...
 * Delete blog post
 */
export const deleteBlog = server$(async (
  token: string,
  id: string
): Promise<boolean> => {
  const client = createAuthenticatedClient(token)
  ...
  try {
    ...
    console.log('🔍 Admin delete blog result:', JSON.stringify(result, null, 2))
 ...
 */
export const bulkUpdateBlogStatus = server$(async (
  token: string,
  ids: string[],
  status: 'DRAFT' | 'PUBLISHED'
): Promise<boolean> => {
  ...
  try {
    ...
    const updatePromises = ids.map(async (id) => {
      ...
      if (result?.errors?.length) {
        ...
        throw new Error(result.errors[0].message || `Failed to update blog ${id}`)
      }
    ...
    throw new Error(error instanceof Error ? error.message : 'Failed to bulk update blog status')
  }
})

                    ...
                    <div class="flex items-center gap-3">
                      <div class="avatar placeholder">
                        <div class="bg-primary text-primary-content rounded-full w-12">
                          <span class="text-xl">{blog.author.charAt(0).toUpperCase()}</span>
                        </div>
                      </div>
                      <div>
...
export const head: DocumentHead = ({ resolveValue }) => {
  ...
  return {
    ...
    meta: [
      {
        name: "description",
        content: blog.summary || blog.metaDescription || `Read "${blog.title}" - A blog post by Hisyam Kamil about web development and technology.`,
      },
      {
        name: "keywords",
        content: blog.tags ? blog.tags.join(', ') : "Blog, Web Development, Programming, Tutorial",
      },
      {
        property: "og:title",
        content: blog.title,
      },
      {
        ...
        content: blog.summary || blog.metaDescription || `Read "${blog.title}" - A blog post by Hisyam Kamil.`,
      },
      {
        property: "og:type",
        content: "article",

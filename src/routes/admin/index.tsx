...
export const useDashboardData = routeLoader$(async (requestEvent) => {
  ...
  try {
    ...
    const stats = {
      ...
      publishedBlogs: blogs.filter(blog => blog.status === 'PUBLISHED' || blog.status === 'published').length,
      draftBlogs: blogs.filter(blog => blog.status === 'DRAFT' || blog.status === 'draft').length,
    ...
    return {
      user: null,
      stats: { totalBlogs: 0, publishedBlogs: 0, draftBlogs: 0, archivedBlogs: 0 },
      recentBlogs: [],
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div class="stats shadow">
          <div class="stat">
            ...
            <div class="stat-value text-success">{data.stats.publishedBlogs}</div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="card bg-base-100 shadow-xl">
          <div class="card-body">
            <div class="flex justify-between items-center mb-4">
              ...
              <a href="/admin/blogs" class="btn btn-sm btn-primary">View All</a>
            </div>
            
            {data.recentBlogs.length === 0 ? (
              <div class="text-center py-8 text-gray-500">
                <p>No blogs found</p>
                <a href="/admin/blogs/new" class="btn btn-primary mt-4">
                  Create First Blog
                </a>
              </div>
            ) : (
              <div class="space-y-4">
                {data.recentBlogs.map((blog) => (
                  <div key={blog.id} class="flex items-center justify-between p-4 border rounded-lg">
                    <div class="flex-1">
                    ...
                    <div class="flex gap-2">
                      <a href={`/admin/blogs/${blog.id}/edit`} class="btn btn-sm btn-ghost">
                        Edit
                      </a>
                      <a href={`/blog/${blog.slug}`} target="_blank" class="btn btn-sm btn-ghost">
                        View
                      </a>
                    </div>
                  </div>
        ...
        <div class="card bg-base-100 shadow-xl">
          <div class="card-body">
            ...
            <div class="space-y-3">
              <a href="/admin/blogs/new" class="btn btn-primary btn-block justify-start">
              ...
              <a href="/admin/blogs" class="btn btn-outline btn-block justify-start">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <a href="/blog" target="_blank" class="btn btn-outline btn-block justify-start">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div class="space-y-3">
              ...
              <div class="flex items-center justify-between">
                ...
                <span class="text-sm text-gray-500">
                  {data.user?.lastLogin ? formatDate(data.user.lastLogin) : 'N/A'}
                </span>
              </div>
            </div>
          </div>

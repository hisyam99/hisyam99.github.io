...
export default component$(() => {
  ...
  return (
    <div style={{ padding: "2rem" }}>
      ...
      >
        <h3>
          Connection Status: {connection.success ? "✅ Success" : "❌ Failed"}
        </h3>
        {connection.success ? (
          <div>
            <p>
              <strong>Status:</strong>{" "}
              {"status" in connection ? connection.status : "N/A"}
            </p>
            <p>
          ...
          <div>
            <p>
              <strong>Error:</strong>{" "}
              {"error" in connection ? connection.error : "Unknown error"}
            </p>
          </div>
        )}
      </div>
        ...
        {debug.success ? (
          <div>
            <details style={{ marginBottom: "1rem" }}>
              <summary>
                <strong>Introspection Query</strong>
              </summary>
              <pre
                style={{
                  background: "#f8f9fa",
            ...
            <details style={{ marginBottom: "1rem" }}>
              <summary>
                <strong>Published Blogs Query</strong>
              </summary>
              <pre
                style={{
                  background: "#f8f9fa",
          ...
          <div>
            <p>
              <strong>Error:</strong>{" "}
              {"error" in debug ? debug.error : "Unknown error"}
            </p>
      ...
      <div style={{ marginTop: "2rem" }}>
        ...
        <ul>
          <li>
            <strong>GraphQL Endpoint:</strong> http://localhost:4001/graphql
          </li>
          <li>

              ...
              <div class="card-body">
                <div class="flex items-center space-x-4 mb-6">
                  ...
                  <div>
                    ...
                    <p class="text-base-content/70">{authUser.value.user.email}</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div class="stat">
                    ...
                    <div class="stat-value text-lg">
                      {new Date(authUser.value.user.createdAt).toLocaleDateString()}
                    </div>
                  </div>
                  <div class="stat">
                    ...
                    <div class="stat-value text-lg">
                      {authUser.value.user.lastLogin ? 
                        new Date(authUser.value.user.lastLogin).toLocaleDateString() : 
                        'Never'
                      }
                    </div>
                  </div>
                  <div class="stat">
                    ...
                    <div class="stat-value text-lg">
                      {new Date(authUser.value.user.updatedAt).toLocaleDateString()}
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div class="stat bg-base-100 rounded-box shadow-xl">
                ...
                <div class="stat-value text-secondary">
                  {Math.floor((Date.now() - new Date(authUser.value.user.createdAt).getTime()) / (1000 * 60 * 60 * 24))}
                </div>
              ...
              <div class="stat bg-base-100 rounded-box shadow-xl">
                ...
                <div class="stat-value text-accent">
                  {authUser.value.user.role === 'ADMIN' ? 'Admin' : 
                   authUser.value.user.role === 'EDITOR' ? 'Editor' : 
                   authUser.value.user.role === 'VIEWER' ? 'Viewer' : 'Guest'}
                </div>

...
const s_pIf0khHUxfY = async (event, elm) => {
  ...
  if (event.defaultPrevented) {
    if (elm.hasAttribute("q:nbs")) await nav2(location.href, {
      type: "popstate"
    });
    else if (elm.href) {
...
export {
  ...
  _jsxQ as b,
  componentQrl as c,
  useVisibleTaskQrl as d,
  _noopQrl as e,
  useLexicalScope as f,
  _jsxC as g,
  _IMMUTABLE as h,
  inlinedQrl as i,
  jsx as j,
  _renderSSR as k,
  _pauseFromContexts as l,
  useDocumentHead as m,
  useLocation as n,
  _fnSignal as o,
  _jsxS as p,
  ServiceWorkerRegister as q,
  routeLoaderQrl as r,
  setPlatform as s,
  useSignal as u,

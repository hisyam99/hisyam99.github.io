...
var _pendingHighSurrogate, _handle, _transform, _a2;
import { getNotFound } from "./@qwik-city-not-found-paths.js";
import { isStaticPath } from "./@qwik-city-static-paths.js";
import { _ as _deserializeData, a as _serializeData, v as verifySerializable$1 } from "./q-DE9SRNy1.js";
import { s as setServerPlatform2, r as render, m as manifest } from "./q-hMElos3p.js";
...
function isContentType(headers, ...types) {
  var _a22;
  const type = ((_a22 = headers.get("content-type")) == null ? void 0 : _a22.split(/;,/, 1)[0].trim()) ?? "";
...
var parseRequest = async ({ request, method, query }, sharedMap, qwikSerializer) => {
  var _a22;
  const type = ((_a22 = request.headers.get("content-type")) == null ? void 0 : _a22.split(/[;,]/, 1)[0].trim()) ?? "";
...
var _TextEncoderStream_polyfill = (_a2 = class {
  constructor() {
...
}, _pendingHighSurrogate = new WeakMap(), _handle = new WeakMap(), _transform = new WeakMap(), _a2);
var MIME_TYPES = {
  "3gp": "video/3gpp",
  "3gpp": "video/3gpp",
  asf: "video/x-ms-asf",
...
function createQwikCity(opts) {
  ...
  const staticFolder = ((_a3 = opts.static) == null ? void 0 : _a3.root) ?? join(Bun.fileURLToPath(import.meta.url), "..", "..", "dist");
